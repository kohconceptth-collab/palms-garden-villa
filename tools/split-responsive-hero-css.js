...
const desktop = "linear-gradient(90deg,rgba(2,12,18,.94),rgba(2,12,18,.55) 38%,rgba(2,12,18,.18) 68%,rgba(2,12,18,.48)),url('../assets/images/gallery-palms/web/IMG-20250930-WA0038.webp') center/cover no-repeat";

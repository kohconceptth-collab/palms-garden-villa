...
$replacements = @(
  ...
  @('BBQ & OUTDOOR DINING', 'BARBECUE & OUTDOOR KITCHEN: LARGE SALA'),
  @('OUTDOOR KITCHEN & SALA', 'BARBECUE & OUTDOOR KITCHEN: LARGE SALA'),
  ...
  @('<section><h3>Website Publisher</h3><p>Palms Garden Villa<br>Phuket, Thailand<br>Website Owner: Chavdar Tiholov<br>Contact: <a href="mailto:office@biomind.bg">office@biomind.bg</a></p></section><section><h3>Hosting Provider</h3><p>SuperHosting.BG Ltd.<br>5 Nikola Tesla Str., BSR 2, 4th Floor<br>1574 Sofia, Bulgaria<br>UIN: 131449987<br>superhosting.bg</p></section>', '<section><h3>Website Publisher</h3><p>Palms Garden Villa<br>Phuket, Thailand<br>Content Manager: Lionel Lopez<br>Email: <a href="mailto:villadreamgarden@gmail.com">villadreamgarden@gmail.com</a></p></section><section><h3>Hosting Provider</h3><p>Website hosting and technical management: Koh Concept<br>Infrastructure provider: HOSTINGER PTE LTD<br>16 Raffles Quay, #33-03, Hong Leong Building<br>Singapore 048581<br>Server location: Malaysia<br>hostinger.com</p></section>'),
  @('Website Owner: Lionel LOPEZ', 'Content Manager: Lionel Lopez<br>Email: <a href="mailto:villadreamgarden@gmail.com">villadreamgarden@gmail.com</a>'),
  @('Website Owner: Michel Henlin', 'Content Manager: Lionel Lopez<br>Email: <a href="mailto:villadreamgarden@gmail.com">villadreamgarden@gmail.com</a>'),
